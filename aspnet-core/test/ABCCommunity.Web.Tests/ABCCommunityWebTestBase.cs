...
{
    public abstract class ABCCommunityWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ABCCommunityWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ABCCommunityWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ABCCommunityDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ABCCommunityDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ABCCommunityDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ABCCommunityDbContext, Task<T>> func)
        {
            T result;
